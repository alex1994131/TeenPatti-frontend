...
import { NavItem, NavLink, UncontrolledDropdown, DropdownMenu, DropdownItem, DropdownToggle, Media, Badge } from "reactstrap"
          ...
          <DropdownToggle tag="a" className="nav-link dropdown-user-link">
            <div className="user-nav d-sm-flex d-none">
              <span className="user-name text-bold-600">
                {userinfo?(userinfo.username?userinfo.username:userinfo.email):''}
              </span>
            ...
            <span data-tour="user">
              {
                userinfo&&userinfo.img?
                  <img src={config.img_url+userinfo.img} className="round" height="40" width="40" alt="avatar"/>:
                  <img src={Images.guest_icon} className="round" height="40" width="40" alt="avatar"/>
              }
            </span>
          </DropdownToggle>
